...
# path.in <- "Y:/Saxons Cloud Data/Cloud Data/Trades_NT7 Backtest/Trades_New/MR/08 05 12/Sells/Smash and Grab/240/"
# path.eod <- "Y:/Saxons Cloud Data/Data History/Revaluation rates/"
# filename <- "BT1 EURUSD 240 Sells_01012006 30062013 b_08 05 12_TSL5 020_P1LB 10 02x.csv"
# file.with.path <- paste0(path.in,filename)
# filestem.out <- substr(filename,start=1,stop=nchar(filename)-4)
# filename <- file.with.path
# path.out <- "Y:/Saxons Cloud Data/Cloud Data/MR/TEST/output/"
# ccy.pair <- "EURUSD"
# strategy <- "MR"
# timeframe <- "240 min"
# strat.dir <- "Short"
